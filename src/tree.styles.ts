export const styles: string[] = [`
  ...
  // propertyes custom
  .tree .folding.node-property {
    content: '\\25D2';
    cursor: pointer;
  }
  .tree .folding.node-property:before {
    content: '\\25D2';
    color: #757575;
  }
  .tree .folding.node-PropertyCollapsed {
    cursor: pointer;
  }
  .tree .folding.node-PropertyCollapsed:before {
    content: '\\25D2';
    color: #757575;
  }
  .tree .folding.node-PropertyExpanded {
    cursor: pointer;
  }
  .tree .folding.node-PropertyExpanded:before {
    content: '\\25D0';
    color: #757575;
  }
  // property end
