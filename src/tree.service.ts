import { NodeRemovedEvent, NodeRenamedEvent, NodeCreatedEvent, NodeSelectedEvent, NodeMovedEvent, ShowObjectsEvent } from './tree.types';
...
export class TreeService {
  ...
  public showObjects$: Subject<ShowObjectsEvent> = new Subject<ShowObjectsEvent>();
}
